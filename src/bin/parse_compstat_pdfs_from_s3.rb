...
if __FILE__ == $0
  ...
  creds = Aws::Credentials.new(ENV["AWS_ACCESS_KEY_ID"] || config['aws']['access_key_id'], 
  ...
  s3 = Aws::S3::Client.new(region: ENV["AWS_S3_REGION"] || config['aws']['s3']['region'] || 'us-east-1', credentials: creds)
  pdf_keys = []
